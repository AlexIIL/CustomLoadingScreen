...
import alexiil.mc.mod.load.baked.func.stack.*;
import alexiil.mc.mod.load.baked.func.stack.op.*;
import alexiil.mc.mod.load.baked.func.stack.var.BakedStackVariable;
