...
public class BakedPostFixFunction<T> extends BakedFunction<T> {
    ...
    public T call(RenderingStatus status, Object... args) throws FunctionException {
        if (args == null && arguments != 0) throw new FunctionException(function, "Was not given any arguments! Wanted " + arguments + ", got 0!");
        if (args != null && args.length != arguments) throw new FunctionException(function, "Was not given enough Arguments! Wanted " + arguments
            + ", got " + args.length + "!");
